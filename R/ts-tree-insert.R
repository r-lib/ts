...
#' @description
#' \eval{tsitter:::doc_insert("ts_tree_insert_description")}
#'
#' \eval{tsitter:::format_rd_parser_list(tsitter:::ts_list_parsers(), "ts_tree_insert")}
#'
...
#'
#' \eval{tsitter:::doc_tabs("ts_tree_insert_details_errors")}
#'
#' If `tree` does not have a selection, the new element is inserted into
#' at the top level.
#'
#' \eval{tsitter:::doc_tabs("ts_tree_insert_details_no_selection")}
#'
#' If `tree` has an empty selection, then it is returned unchanged, i.e.
#' no new element is inserted.
#'
#' \eval{tsitter:::doc_tabs("ts_tree_insert_details_empty_selection")}
#' @details
#' \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_details")}
...
#'
#' @param tree \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_param_tree")}
#' @param new \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_param_new")}
#'
...
#' @param key \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_param_key")}
#'
#' For example a JSON(C) object or a TOML table are keyed elements.
#' @param at \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_param_at")}
#'
...
#' @param options \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_param_options")}
#'
...
#' @return \eval{tsitter:::doc_insert("tsitter::ts_tree_insert_return")}
#'
#' @family ts_tree generics
#' @seealso \eval{tsitter:::doc_seealso("ts_tree_insert")}
#' @export
