...
- **Tree-sitter authors**. Copyright holder.  
  Tree-sitter C library, see AUTHORS file

- **ICU authors**. Copyright holder.  
  ICU library, see AUTHORS file

## Citation

Source:
[`DESCRIPTION`](https://github.com/r-lib/tsitter/blob/v0.1.0/DESCRIPTION)

Csárdi G (2026). *tsitter: Tree-Sitter Parsing Tools*. R package version
0.1.0, <https://github.com/r-lib/tsitter>.
...
## Additional details
    ...
    Tree-sitter library, https://github.com/tree-sitter/tree-sitter
    ...
    * zyoshoka
    ...
    icu library, https://github.com/unicode-org/icu
